    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="flex items-center justify-between font-mono text-[11px] uppercase tracking-[0.2em] text-black/50 mb-12 md:mb-20 reveal">
          <span data-testid="hero-meta-portfolio">Portfolio · 2013 — 2025</span>
          ...
          <span className="hidden md:inline" data-testid="hero-meta-status">
            ...
            Currently leading TDM @ Northwind
          </span>
        </div>

        <div className="grid grid-cols-12 gap-6 md:gap-10 items-end">
          {/* Left: massive type */}
          <div className="col-span-12 lg:col-span-8 reveal" style={{ animationDelay: "120ms" }}>
            <p className="font-mono text-[11px] uppercase tracking-[0.2em] text-black/50 mb-6">
              ↳ {profile.role}
            </p>
            <h1
              data-testid="hero-name"
              className="font-display font-black tracking-[-0.04em] leading-[0.85] text-[14vw] sm:text-[12vw] lg:text-[10.5rem] xl:text-[12rem]"
            >
              {profile.firstName}
              <br />
              <span className="text-[#002FA7]">{profile.lastName}.</span>
            </h1>
          ...
          {/* Right: portrait */}
          <div className="col-span-12 lg:col-span-4 reveal" style={{ animationDelay: "260ms" }}>
        ...
        <div className="mt-16 md:mt-24 flex items-center gap-3 font-mono text-[11px] uppercase tracking-[0.2em] text-black/50">
          ...
          <span>Scroll · Twelve years, briefly told</span>
        </div>
      </div>
    </section>
  );
